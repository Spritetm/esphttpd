...
static
void ICACHE_FLASH_ATTR mem_cpy (void* dst, const void* src, UINT cnt) {
	BYTE *d = (BYTE*)dst;
...
/* Fill memory */
static
void ICACHE_FLASH_ATTR mem_set (void* dst, int val, UINT cnt) {
	BYTE *d = (BYTE*)dst;
...
static
int ICACHE_FLASH_ATTR mem_cmp (const void* dst, const void* src, UINT cnt) {
...
static
int ICACHE_FLASH_ATTR chk_chr (const char* str, int chr) {
...
static
void ICACHE_FLASH_ATTR unlock_fs (
	FATFS* fs,		/* File system object */
...
static
FRESULT ICACHE_FLASH_ATTR chk_lock (	/* Check if the file can be accessed */
...
static
int ICACHE_FLASH_ATTR enq_lock (void)	/* Check if an entry is available for a new object */
{
	UINT i;
...
static
UINT ICACHE_FLASH_ATTR inc_lock (	/* Increment object open counter and returns its index (0:Internal error) */
...
static
FRESULT ICACHE_FLASH_ATTR dec_lock (	/* Decrement object open counter */
...
#if !_FS_READONLY
static
FRESULT ICACHE_FLASH_ATTR sync_window (
	FATFS* fs		/* File system object */
)
{
	DWORD wsect;
...
static
FRESULT ICACHE_FLASH_ATTR move_window (
	FATFS* fs,		/* File system object */
...
#if !_FS_READONLY
static
FRESULT ICACHE_FLASH_ATTR sync_fs (	/* FR_OK: successful, FR_DISK_ERR: failed */
	FATFS* fs		/* File system object */
)
{
	FRESULT res;
...
DWORD ICACHE_FLASH_ATTR get_fat (	/* 0xFFFFFFFF:Disk error, 1:Internal error, 2..0x0FFFFFFF:Cluster status */
	FATFS* fs,	/* File system object */
...
#if !_FS_READONLY
FRESULT ICACHE_FLASH_ATTR put_fat (
	FATFS* fs,	/* File system object */
...
#if !_FS_READONLY
static
FRESULT ICACHE_FLASH_ATTR remove_chain (
	FATFS* fs,			/* File system object */
...
#if !_FS_READONLY
static
DWORD ICACHE_FLASH_ATTR create_chain (	/* 0:No free cluster, 1:Internal error, 0xFFFFFFFF:Disk error, >=2:New cluster# */
	FATFS* fs,			/* File system object */
...
#if _USE_FASTSEEK
static
DWORD ICACHE_FLASH_ATTR clmt_clust (	/* <2:Error, >=2:Cluster number */
...
static
FRESULT ICACHE_FLASH_ATTR dir_sdi (
...
static
FRESULT ICACHE_FLASH_ATTR dir_next (	/* FR_OK:Succeeded, FR_NO_FILE:End of table, FR_DENIED:Could not stretch */
...
#if !_FS_READONLY
static
FRESULT ICACHE_FLASH_ATTR dir_alloc (
	DIR* dp,	/* Pointer to the directory object */
...
static
DWORD ICACHE_FLASH_ATTR ld_clust (
...
static
int ICACHE_FLASH_ATTR cmp_lfn (			/* 1:Matched, 0:Not matched */
...
static
int ICACHE_FLASH_ATTR pick_lfn (			/* 1:Succeeded, 0:Buffer overflow */
...
#if !_FS_READONLY
static
void ICACHE_FLASH_ATTR fit_lfn (
...
static
void ICACHE_FLASH_ATTR gen_numname (
...
#if _USE_LFN
static
BYTE ICACHE_FLASH_ATTR sum_sfn (
...
static
FRESULT ICACHE_FLASH_ATTR dir_find (
...
static
FRESULT ICACHE_FLASH_ATTR dir_read (
	DIR* dp,		/* Pointer to the directory object */
...
#if !_FS_READONLY
static
FRESULT ICACHE_FLASH_ATTR dir_register (	/* FR_OK:Successful, FR_DENIED:No free entry or too many SFN collision, FR_DISK_ERR:Disk error */
...
static
FRESULT ICACHE_FLASH_ATTR dir_remove (	/* FR_OK: Successful, FR_DISK_ERR: A disk error */
...
static
void ICACHE_FLASH_ATTR get_fileinfo (		/* No return code */
	DIR* dp,			/* Pointer to the directory object */
...
static
WCHAR ICACHE_FLASH_ATTR get_achar (		/* Get a character and advances ptr 1 or 2 */
...
static
int ICACHE_FLASH_ATTR pattern_matching (	/* Return value: 0:mismatched, 1:matched */
...
static
FRESULT ICACHE_FLASH_ATTR create_name (
	DIR* dp,			/* Pointer to the directory object */
...
static
FRESULT ICACHE_FLASH_ATTR follow_path (	/* FR_OK(0): successful, !=0: error code */
...
static
int ICACHE_FLASH_ATTR get_ldnumber (		/* Returns logical drive number (-1:invalid drive) */
...
static
BYTE ICACHE_FLASH_ATTR check_fs (	/* 0:FAT boor sector, 1:Valid boor sector but not FAT, 2:Not a boot sector, 3:Disk error */
	FATFS* fs,	/* File system object */
...
static
FRESULT ICACHE_FLASH_ATTR find_volume (	/* FR_OK(0): successful, !=0: any error occurred */
...
static
FRESULT ICACHE_FLASH_ATTR validate (	/* FR_OK(0): The object is valid, !=0: Invalid */
...
static
void ICACHE_FLASH_ATTR putc_bfd (
	putbuff* pb,
	TCHAR c
)
{
